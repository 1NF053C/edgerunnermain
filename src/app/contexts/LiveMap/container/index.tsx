...
import { MapboxMap } from "@1nf053c/mapbox-map"; //"../components/MapboxMap/src";
...
export function MapboxMapContainer() {
    ...
    return <MapboxMap publicKey={data[0].publicKey} startLng={data[0].startLng} startLat={data[0].startLat} zoomLevel={data[0].zoomLevel} />
}
